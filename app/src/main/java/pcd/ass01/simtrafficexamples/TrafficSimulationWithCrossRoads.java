...
public class TrafficSimulationWithCrossRoads extends AbstractSimulation {
	...
	public void setup() {
		...
		CarAgent car1 = new CarAgentExtended("car-1", env, r1, 123);
		this.addAgent(car1);		
		CarAgent car2 = new CarAgentExtended("car-2", env, r1,  234);
		this.addAgent(car2);		
		...
		CarAgent car3 = new CarAgentExtended("car-3", env, r2, 234);
		this.addAgent(car3);		
		CarAgent car4 = new CarAgentExtended("car-4", env, r2, 23423);
		this.addAgent(car4);
